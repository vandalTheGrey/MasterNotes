...
```shell
p3ta@htb[/htb]$ curl -u admin:admin http://<SERVER_IP>:<PORT>/
...
```shell
p3ta@htb[/htb]$ curl http://admin:admin@<SERVER_IP>:<PORT>/
...
```shell
p3ta@htb[/htb]$ curl -v http://admin:admin@<SERVER_IP>:<PORT>/
...
```shell
p3ta@htb[/htb]$ curl -H 'Authorization: Basic YWRtaW46YWRtaW4=' http://<SERVER_IP>:<PORT>/
...
```shell
p3ta@htb[/htb]$ curl 'http://<SERVER_IP>:<PORT>/search.php?search=le' -H 'Authorization: Basic YWRtaW46YWRtaW4='
...
![[Pasted image 20231215103224.png]]