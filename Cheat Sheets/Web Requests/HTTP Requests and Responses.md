...
![raw_request](HTB%20Enterprise/raw_request.png)
...
![raw_response](HTB%20Enterprise/raw_response.png)
...
```shell
p3ta@htb[/htb]$ curl inlanefreight.com -v
...
If we click on the Network tab and refresh the page, we should be able to see the list of requests sent by the page: ![devtools_network_requests](HTB%20Enterprise/devtools_network_requests.jpg)
...
![[Pasted image 20231215092455.png]]
...
Running the same request gets the flag.

![[Pasted image 20231215093249.png]]