...
```javascript
function generateSerial() { ...SNIP... var xhr = new XMLHttpRequest; var url = "/serial.php"; xhr.open("POST", url, true); xhr.send(null); };
```
...
We would need to manually reverse engineer the code to understand how it was obfuscated and its functionality for such cases. If you are interested in knowing more about advanced JavaScript Deobfuscation and Reverse Engineering, you can check out the [Secure Coding 101](https://enterprise.hackthebox.com/academy-lab/7282/preview/modules/38) module, which should thoroughly cover this topic.

# Assessment 

![[Pasted image 20240102150827.png]]

![[Pasted image 20240102150850.png]]