...
```shell
p3ta@htb[/htb]$ ls /var/lib/php/sessions
...
```sql
show databases; use project; show tables; select * from users;
```
...
```sql
select * from all_sessions; select * from all_sessions where id=3;
```
