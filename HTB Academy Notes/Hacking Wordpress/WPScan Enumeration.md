...
```shell
p3ta@htb[/htb]$ wpscan --url http://blog.inlanefreight.com --enumerate --api-token Kffr4fdJzy9qVcTk<SNIP>
...
```
wpscan --url http://94.237.56.175:34755 -e ap
```

![[Pasted image 20231215152748.png]]