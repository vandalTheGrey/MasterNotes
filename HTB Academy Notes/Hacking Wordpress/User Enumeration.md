...
![[Pasted image 20231215150359.png]]
...
```shell
p3ta@htb[/htb]$ curl -s -I -X GET http://blog.inlanefreight.com/?author=1
...
```shell
p3ta@htb[/htb]$ curl -s -I -X GET http://blog.inlanefreight.com/?author=100
...
```shell
p3ta@htb[/htb]$ curl http://blog.inlanefreight.com/wp-json/wp/v2/users | jq
