...
```http
POST /change_password POST body: new_password=pwned&confirm_new=pwned
```
...
```http
POST /change_password POST body: new_password=qwerty&csrf_token=9cfffd9e8e78bd68975e295d1b3d3331
```
...
```http
POST /change_password POST body: new_password=qwerty&csrf_token=
```
