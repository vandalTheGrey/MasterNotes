...
![client-server](HTB%20Enterprise/client-server-model.jpg)
...
![one-server](HTB%20Enterprise/one-server-arch.jpg)
...
![many-server-one-db](HTB%20Enterprise/many-server-one-db-arch.jpg)
...
![many-server-many-db](HTB%20Enterprise/many-server-many-db-arch.jpg)
...
![image](HTB%20Enterprise/image5-12.png) Source: [Microsoft Docs](https://docs.microsoft.com/en-us/dotnet/architecture/modern-web-apps-azure/common-web-application-architectures)
