...
![web server](HTB%20Enterprise/web-server-requests.jpg)
...
```shell
p3ta@htb[/htb]$ curl -I https://academy.hackthebox.com
...
```shell
p3ta@htb[/htb]$ curl https://academy.hackthebox.com
...
![Apache](HTB%20Enterprise/apache.png)
...
![NGINX](HTB%20Enterprise/nginx.png)
